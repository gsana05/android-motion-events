...
public class ZoomLayout extends FrameLayout implements ScaleGestureDetector.OnScaleGestureListener {
	...
	public boolean onTouchEvent(MotionEvent motionEvent) {
		if(!canZoom){
			Log.i(TAG, "zoom model- touch event: canZoom is FALSE");
			return false;
		}

		Log.i(TAG, "zoom model- touch event action " + motionEvent.getAction() + " action mask: " + motionEvent.ACTION_MASK);
		switch (motionEvent.getAction() & MotionEvent.ACTION_MASK) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				break;
			case MotionEvent.ACTION_POINTER_DOWN: // two or more fingers on the screen
				mode = Mode.ZOOM;
				Log.i(TAG, "zoom model- touch event: ACTION_POINTER_DOWN");
				break;
			case MotionEvent.ACTION_POINTER_UP:
				mode = Mode.DRAG;
				Log.i(TAG, "zoom model- touch event: ACTION_POINTER_UP");
				break;
